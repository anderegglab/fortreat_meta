...
text(275, 4.3, "Egger's test for asymmetry:", adj = c(0,0), cex = 1)
text(275, 4, "p = 0.26", adj = c(0,0), cex = 1)
box()
dev.off()
...
abline(intercept_bar, beta_bar, col = "red", lwd = 2)
text(60, 1.2, "Egger's test for asymmetry:", adj = c(0,0), cex = 1)
text(60, 1.05, "p = 0.60", adj = c(0,0), cex = 1)
box()
dev.off()
